...
class Ventas{
    ...
    {
        $consult = $this->pdo->prepare("SELECT temp.*, pro.descripcion FROM temp_ventas temp INNER JOIN producto pro ON temp.id_producto = pro.codproducto WHERE temp.id_usuario = ? and temp.cantidad<=pro.existencia");
    ...
    {
        $consult = $this->pdo->prepare("SELECT * FROM temp_ventas temp INNER JOIN producto pro ON temp.id_producto = pro.codproducto WHERE temp.cantidad<=pro.existencia and  temp.id_producto = ? AND temp.id_usuario = ?");
