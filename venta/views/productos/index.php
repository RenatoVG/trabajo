...
<form id="frmProductos" autocomplete="off">
    <div class="card mb-2">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="barcode" name="barcode" placeholder="Barcode" value="<?php echo $cad;?>" readonly="readonly">
                    </div>
                </div>
                <div class="col-md-5">
        ...
        <div class="card-footer text-right">
            ...
            <a href="/venta/views/productos/reporteproductos.php" class="btn btn-danger">PDF</a>
        </div>
    </div>
</form>
<div class="card">
