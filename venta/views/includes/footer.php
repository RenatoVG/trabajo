...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span><b>Copyright<b> &copy; POLISHOES S.R.L. Website <?php echo date('Y'); ?></span>
        </div>
    </div>
</footer>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php echo RUTA . 'presenter/ventasPresenter.php?option=logout'; ?>">salir</a>
            </div>
        </div>
    </div>
</div>
