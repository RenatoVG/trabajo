            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" readonly="readonly">
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-6">                    
                    <div class="form-group">
                        ...
                        <textarea id="direccion" class="form-control" name="direccion" rows="3" placeholder="Dirección" readonly="readonly"></textarea>
                    </div>
                </div>
            </div>
        </div>
