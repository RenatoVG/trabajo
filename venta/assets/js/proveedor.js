...
document.addEventListener('DOMContentLoaded', function () {
  $('#table_proveedores').DataTable({
    ajax: {
      url: ruta + 'presenter/proveedorPresenter.php?option=listar',
      dataSrc: ''
    },
    columns: [
      { data: 'idproveedor' },
  ...
  frm.onsubmit = function (e) {
    ...
    if (telefono.value == '' || nombre.value == ''
      ...
      axios.post(ruta + 'presenter/proveedorPresenter.php?option=save', frmData)
...
function deleteProveedor(id) {
  Snackbar.show({
    ...
    onActionClick: function (element) {
      axios.get(ruta + 'presenter/proveedorPresenter.php?option=delete&id=' + id)
        .then(function (response) {
          const info = response.data;
          message(info.tipo, info.mensaje);
          if (info.tipo == 'success') {
...
function editProveedor(id) {
  axios.get(ruta + 'presenter/proveedorPresenter.php?option=edit&id=' + id)
    .then(function (response) {
      const info = response.data;
