...
document.addEventListener('DOMContentLoaded', function () {
  $('#table_clientes').DataTable({
    ajax: {
      url: ruta + 'presenter/clientesPresenter.php?option=listar',
      dataSrc: ''
    },
    columns: [
      { data: 'idcliente' },
  ...
  frm.onsubmit = function (e) {
    ...
    if (telefono.value == '' || nombre.value == ''
      ...
      axios.post(ruta + 'presenter/clientesPresenter.php?option=save', frmData)
...
function deleteCliente(id) {
  Snackbar.show({
    ...
    onActionClick: function (element) {
      axios.get(ruta + 'presenter/clientesPresenter.php?option=delete&id=' + id)
        .then(function (response) {
          const info = response.data;
          message(info.tipo, info.mensaje);
          if (info.tipo == 'success') {
...
function editCliente(id) {
  axios.get(ruta + 'presenter/clientesPresenter.php?option=edit&id=' + id)
    .then(function (response) {
      const info = response.data;
